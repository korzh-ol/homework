...
namespace PhotoEnhancer
{
    public partial class MainForm : Form
    {
        ...
        private void buttonApply_Click(object sender, EventArgs e)
        {
            ...
            if (filter.GetParametersInfo().Any(nameof => nameof.Name.Equals("Rotate")))
            {
                pictureBoxResult.Image = Convertors.RotateAndFlip(resultPhoto);
               
            }
         /*   if (filter.GetParametersInfo().Any(nameof => nameof.Name.Equals("Done")))
            {   
